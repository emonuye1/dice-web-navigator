...
const Index = () => {
  ...
  const webApps = [
    ...
    {
      id: "cadangan-remot-dadu-merah",
      title: "Cadangan remot dadu merah",
      description: "Cadangan remote control untuk dadu merah",
      url: "https://firmanuye12.github.io/cadangan-remot-merah/",
      color: "bg-pink-500 hover:bg-pink-600",
    },
    {
      id: "monitor-remot-dadu-merah",
      title: "Monitor remot dadu merah",
      description: "Monitor untuk remote dadu merah",
